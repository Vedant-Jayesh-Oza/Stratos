...
def main():
    print("Stratos Researcher Service - Docker Deployment")
    print("===========================================")
    ...
    ecr_repository = "stratos-researcher"
    ...
    try:
        services = run_command(
            [
                ...
                region,
                "--query",
                "ServiceSummaryList[?ServiceName=='stratos-researcher'].ServiceArn",
                "--output",
                "json",
            ],
            capture_output=True,
        ...
        if services:
            ...
            if service_arns:
                                ...
                                "ImageRepository": {
                                    ...
                                    "ImageConfiguration": {
                                        ...
                                        "RuntimeEnvironmentVariables": {
                                            ...
                                            "STRATOS_API_KEY": os.environ.get("STRATOS_API_KEY", ""),
                                            "STRATOS_API_ENDPOINT": os.environ.get(
                ...
                print("  2. Select 'stratos-researcher' service")
