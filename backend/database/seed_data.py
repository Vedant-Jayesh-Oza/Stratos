"""
Seed data for Stratos Financial Planner
...
database = os.environ.get("AURORA_DATABASE", "stratos")
...
INSTRUMENTS = [
    ...
    },
    {
        ...
        "instrument_type": "etf",
        "current_price": 60.00,
        "allocation_regions": {"europe": 45, "asia": 35, "latin_america": 10, "africa": 5, "oceania": 5},
        "allocation_sectors": {
            "financials": 18,
            "industrials": 14,
            "technology": 13,
