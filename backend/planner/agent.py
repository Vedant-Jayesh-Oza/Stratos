...
TAGGER_FUNCTION = os.getenv("TAGGER_FUNCTION", "stratos-tagger")
REPORTER_FUNCTION = os.getenv("REPORTER_FUNCTION", "stratos-reporter")
CHARTER_FUNCTION = os.getenv("CHARTER_FUNCTION", "stratos-charter")
RETIREMENT_FUNCTION = os.getenv("RETIREMENT_FUNCTION", "stratos-retirement")
