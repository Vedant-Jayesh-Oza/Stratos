...
resource "aws_secretsmanager_secret" "db_credentials" {
  name                    = "stratos-aurora-credentials-${random_id.suffix.hex}"
...
resource "aws_db_subnet_group" "aurora" {
  name       = "stratos-aurora-subnet-group"
...
resource "aws_security_group" "aurora" {
  name        = "stratos-aurora-sg"
  description = "Security group for Stratos Aurora cluster"
...
resource "aws_rds_cluster" "aurora" {
  cluster_identifier     = "stratos-aurora-cluster"
  engine                 = "aurora-postgresql"
  engine_mode            = "provisioned"
  engine_version         = "15.12"
  database_name          = "stratos"
  master_username        = "stratosadmin"
...
resource "aws_rds_cluster_instance" "aurora" {
  identifier          = "stratos-aurora-instance-1"
...
resource "aws_iam_role" "lambda_aurora_role" {
  name = "stratos-lambda-aurora-role"
...
resource "aws_iam_role_policy" "lambda_aurora_policy" {
  name = "stratos-lambda-aurora-policy"
